...
| HOS-1: low-friction calendar ingestion and delivery | planned | Turn dated images, PDFs, and similar artifacts into canonical HOUSE events; configure provider delivery during setup; reconcile without duplicates; connect events to preparation work. |
